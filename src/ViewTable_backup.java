...
import project_sanwa_new.CountToAlert;
...
public class ViewTable_backup extends javax.swing.JPanel implements ActionListener {
    ...
    static Map<String, String> midNightDateTime;
    ...
    private List<CountToAlert> countToAlert;
    ...
    private void loadData() {
        ...
        dbD.connect();
        dbDrago.connect();
        rangeAlert = dbDrago.selectTimeAlertByDragoConnexID(SelectComboBox.getDragoConnexID());
